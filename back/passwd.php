...
<body ng-controller="MainController as main">
    <div class="container">
        ...
        <!-- LIST -->
		<form ng-submit="main.show()" class="card" style="margin-bottom:1vh" ng-hide="main.isConnected">
        ...
        <div id="passwords-list" class="card" ng-show="main.isConnected && main.passwords.length > 0">
